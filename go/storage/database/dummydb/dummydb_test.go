...
import (
	...
	. "github.com/michaelhendraw/library/go/storage/database/dummydb"
...
func TestRunQuery(t *testing.T) {
	...
	// SELECT
	sMock.ExpectQuery(`SELECT id FROM table_name`).WillReturnError(errors.New("Foo"))
...
func TestRunQueryUpdateBeginCommit(t *testing.T) {
	...
	sMock.ExpectBegin()
	sMock.ExpectExec("UPDATE table_name").WithArgs(123, 123).WillReturnResult(sqlmock.NewResult(1, 1))
	sMock.ExpectCommit()
